...
return (
    <div className='propos'>
        ...
        <p className='p_propos'>
            ...
            Son engagement est de cultiver une relation basée sur la confiance et la transparence avec ses clients, dans le but de mettre en œuvre la stratégie la plus adaptée à leur situation. En cas de litiges, elle s'efforce de défendre leurs intérêts avec ténacité et efficacité.<br></br>
        ...
        <p className='p_parcours'>
            Maître Dalia MIMOUN est une avocat chevronnée au Barreau de Seine-Saint-Denis (BOBIGNY), dont le parcours remarquable reflète son engagement indéfectible envers la justice et le droit. <br></br>
            Dès ses débuts dans le monde du droit après avoir obtenu son bac B en 1993, elle a rapidement gravi les échelons académiques. <br></br>
            ...
            Depuis 2005, Maître MIMOUN exerce seule à son compte. <br></br>
            Parallèlement à son activité d'avocat, elle enseigne à l'université Sorbonne PARIS NORD au département GEA depuis 2006.<br></br>
